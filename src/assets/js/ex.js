/* #vfic now: 15 Apr 2018 09:19:46 on web251 */
function trim(e) {
...
function toggleAdvancedSearch() {
  ...
  "on" == advanced.className ? (setInnerText("simpleAdvancedLink", ShowAdvancedSearch),
    advanced.className = "off") :(setInnerText("simpleAdvancedLink", HideAdvancedSearch),
    advanced.className = "on"), "function" == typeof toggleAdvanceSearchCallBack && eval("toggleAdvanceSearchCallBack()");
}
...
function preLoadNavigationImages(theme) {
  ...
  -1 == theme.indexOf("/FP") && (theme = "/FP" + theme), navigationButtonStr += ' "' + theme + '/NavigationLine/Images/LTR/buttonBack.png" ',
  ...
  navigationButtonStr && (navigationButtonStr = "preloadImages(" + navigationButtonStr + ")",
...
function openCenteredPopup2(e, t, n, a, r, o, i, l) {
  ...
  if (-1 != u) {
    var d = r.indexOf(";", u);
    s = -1 == d ? r.substring(u + 7, r.length) :r.substring(u + 7, d), ("yes" == s || "1" == s || "on" == s) && (s = "auto");
  }
...
function setObjInnerText(e, t) {
  document.all ? e.innerText = t :e.textContent = t;
}
...
function tohex(i) {
  var a2 = "", ihex = hexQuot(i), idiff = eval(i + "-(" + ihex + "*16)");
  for (a2 = itohex(idiff) + a2; ihex >= 16; ) {
    var itmp = hexQuot(ihex);
    idiff = eval(ihex + "-(" + itmp + "*16)"), a2 = itohex(idiff) + a2, ihex = itmp;
  }
  var a1 = itohex(ihex);
  return a1 + a2;
}
...
function collapseExpandWidget(e, t, n) {
  ...
  var l = "WidgetState_" + e;
  siteServerSideCookieSet(COOKIE_TYPE_SITE_GENERAL, cookieSiteID, l, a, n, currentUserAccountID);
}
...
function isEmptyString(objWord, strErrorMesg) {
  var blnIsEmpty = !0, blnObjectPrm = !1, i = 0, strWord = "", objThis;
  for (isIE && (blnObjectPrm = "object" == typeof objWord ? !0 :!1), blnObjectPrm ? (objThis = objWord,
    strWord = objWord.value) :"document" == objWord.substring(0, 8) ? (objThis = eval(objWord),
    strWord = objThis.value, blnObjectPrm = !0) :strWord = objWord; i < strWord.length && blnIsEmpty; ) " " != strWord.charAt(i) && (blnIsEmpty = !1),
    i++;
  return blnIsEmpty && "" != strErrorMesg && (alert(strErrorMesg), blnObjectPrm && objThis.focus()),
    blnIsEmpty;
}
...
function saveDefaultReferer() {
  ...
  "" != a && (setCookie("DefaultSave", a), "bebo" == a && setCookie("CelebrityDemoTab", "bebo"));
}

var supportedReferersForDefaultSaveCookieIsManipulation = new Array();

supportedReferersForDefaultSaveCookieIsManipulation.bebo = "bebo", supportedReferersForDefaultSaveCookieIsManipulation.facebook = "facebook",
  supportedReferersForDefaultSaveCookieIsManipulation.friendster = "friendster", supportedReferersForDefaultSaveCookieIsManipulation.myspace = "myspace",
  supportedReferersForDefaultSaveCookieIsManipulation.xanga = "xanga", supportedReferersForDefaultSaveCookieIsManipulation.hi5 = "hi5",
  supportedReferersForDefaultSaveCookieIsManipulation.livejournal = "livejournal",
  ...
  supportedReferersForDefaultSaveCookieIsManipulation.freewebs = "freewebs", supportedReferersForDefaultSaveCookieIsManipulation.yahoo360 = "yahoo360",
  supportedReferersForDefaultSaveCookieIsManipulation.facebox = "facebox", supportedReferersForDefaultSaveCookieIsManipulation.piczo = "piczo",
  supportedReferersForDefaultSaveCookieIsManipulation.blackplanet = "blackplanet",
  supportedReferersForDefaultSaveCookieIsManipulation.orkut = "orkut", supportedReferersForDefaultSaveCookieIsManipulation.tagged = "tagged",
  supportedReferersForDefaultSaveCookieIsManipulation.myyearbook = "myyearbook", supportedReferersForDefaultSaveCookieIsManipulation.wordpress = "wordpress",
  supportedReferersForDefaultSaveCookieIsManipulation.igoogle = "igoogle", supportedReferersForDefaultSaveCookieIsManipulation.netvibes = "netvibes",
  supportedReferersForDefaultSaveCookieIsManipulation.pageflakes = "pageflakes", supportedReferersForDefaultSaveCookieIsManipulation.comment = "comment",
  supportedReferersForDefaultSaveCookieIsManipulation.vox = "vox", supportedReferersForDefaultSaveCookieIsManipulation.migente = "migente",
  saveDefaultReferer();
!function(i, n) {
  "use strict";
  function r(i) {
...
!function(o, e) {
  "use strict";
  function s(o, s, i, n, t) {
    return this.hasError = !1, _.isBoolean(t) || (t = !0), this.shouldPrintErrors = t,
      o && s ? (this.windowObj = n || e, _.isFunction(this.windowObj.openNewPopup) ? (this.siteId = o,
        this.lang = s, void (this.csrfToken = i)) :(this.shouldPrintErrors && console.error("NewPasswordPopupOpener constructor: could not find the openNewPopup function."),
        void (this.hasError = !0))) :(this.shouldPrintErrors && console.error("NewPasswordPopupOpener constructor: incorrect parameters."),
        void (this.hasError = !0));
  }
  var i = [ "mhPopupReady", "OnBeforeClose" ];
  s.prototype.open = function(o) {
    if (!this.hasError && !this._popupIsOpen) {
      this._popupIsOpen = !0;
      var e = [ "", "FP", "Library", "Members", "NewPassword", "change-initial-password.php" ].join("/"), s = "s=" + this.siteId + "&lang=" + this.lang, i = this._createSimpleModalOptions(o);
      this.windowObj.openNewPopup(e, s, i);
    }
  }, s.prototype._createSimpleModalOptions = function(o) {
    o = o || {};
    var s = e.familyHomeData && e.familyHomeData.isMobilePhone || e.newTree && e.newTree.canvas.getIsMobilePhone(), i = {
      opacity:60,
      isInMobile:s
    };
    return o = _.extend(i, o), this._addSimpleModalListeners(o), o.modal = !0, o;
  }, s.prototype._addSimpleModalListeners = function(o) {
    var e = this;
    _.each(i, function(s) {
      if (_.isFunction(o[s])) {
        var i = o[s];
        o[s] = function() {
          e[s].apply(e, arguments), i.apply(null, arguments);
        };
      } else o[s] = _.bind(e[s], e);
    });
  }, s.prototype.mhPopupReady = function() {
    this.windowObj.NewPasswordPopup.NewPasswordPopupReady(this.siteId, this.lang, this.csrfToken);
  }, s.prototype.OnBeforeClose = function() {
    this._popupIsOpen = !1;
  }, o.NewPasswordPopupOpener = s;
}(window, window);
...
function isEmail(e, r, i) {
  "undefined" == typeof r && (r = !0), gWasEmailLegal = e.match(/^[_a-z0-9-]+((\.|\+)[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.(?:[a-z]{2,4}|email))$/i) ? !0 :!1;
  var t = "spam|fake|bugme|fuck|mailinator|junk|crap@|trashmail|trash-mail|pookmail";
  i || (t += "|myheritage.com");
  var a = new RegExp(t, "i");
  return 1 == r && gWasEmailLegal && e.match(a) ? e.match(/junkie/i) || e.match(/junker/i) ? !0 :!1 :gWasEmailLegal;
}

function isPositiveNumber(objNumber, strErrorMesg) {
  var blnIsPositiveNumber = !0, blnObjectPrm = !1, strNumber = "", objThis;
  return isIE && (blnObjectPrm = "object" == typeof objNumber ? !0 :!1), blnObjectPrm ? (objThis = objNumber,
    strNumber = objNumber.value) :"document" == objNumber.substring(0, 8) ? (objThis = eval(objNumber),
    strNumber = objThis.value, blnObjectPrm = !0) :strNumber = objNumber, blnIsPositiveNumber = isNaN(strNumber) ? !1 :0 >= strNumber ? !1 :!0,
  blnIsPositiveNumber || "" == strErrorMesg || (alert(strErrorMesg), blnObjectPrm && objThis.focus()),
    blnIsPositiveNumber;
}
...
function isValidUrl(e, r) {
  if ("undefined" == typeof r && (r = !0), "undefined" == typeof e || null == e || "" == e) return !1;
  initValidUrlRE();
  var i = e.match(validUrlRE);
  return i && "undefined" != typeof i.length && i.length > 1 ? null == i[1] && r ? !1 :!0 :!1;
}

function getUrlForBrowser(e) {
  initValidUrlRE();
  var r = e.match(validUrlRE);
  return r && "undefined" != typeof r.length && r.length > 1 ? (null == r[1] && (e = "http://" + e),
    e) :null;
}

var gWasEmailLegal = !1;
function serverSideCookieIsSuccessResponse(e) {
  var s = e.indexOf("<error");
  return 0 != s;
}

function serverSideCookieGetCookieValueFromResponse(e) {
  if (0 == serverSideCookieIsSuccessResponse(e)) return "";
  var s = "", r = e.indexOf("<value><![CDATA[") + 16, o = e.indexOf("]]></value>");
  return -1 != r && -1 != o && o >= r && (s = e.substring(r, o)), s;
}

function serverSideCookieCallback(objID, response, callbackFunc) {
  response = unescape(response);
  var success = serverSideCookieIsSuccessResponse(response), successString = "", value = "";
  success ? (successString = "true", value = serverSideCookieGetCookieValueFromResponse(response)) :(successString = "false",
    value = ""), null != callbackFunc && "" != callbackFunc && eval("" + callbackFunc + "(" + successString + ",'" + value + "')");
}

function serverSideCookieSendAjaxRequest(e, s, r) {
  var o = getAjaxObject();
  sendAjaxRequest(o, "/FP" + e, s, "", "POST", "serverSideCookieCallback", r, "");
}

function siteServerSideCookieSet(e, s, r, o, i, n, c) {
  null == c && (c = "");
  var u = "cookieType=" + e + "&siteID=" + s + "&command=set&key=" + r + "&value=" + o + "&expirationFromNow=" + i + "&accountID=" + n;
  serverSideCookieSendAjaxRequest(SITE_SERVER_SIDE_COOKIE_API_LOCATION, u, c);
}

var SITE_SERVER_SIDE_COOKIE_API_LOCATION = "/API/ServerSideCookie/site-server-side-cookie-entry.php", COOKIE_TYPE_SITE_GENERAL = 1;
function disableCssButton(t) {
  disableCssButtonObject(jQuery("#" + t));
}

function disableCssButtonObject(t) {
  if (!t.hasClass("css_button_disabled")) {
    var s = t.attr("onclick");
    t.addClass("css_button_disabled"), t.data("onclick", s ? s :""), t.attr("onclick", "return false;"),
...
function enableCssButtonObject(t) {
  if (t.hasClass("css_button_disabled")) {
    var s = t.data("onclick");
    t.removeClass("css_button_disabled"), t.removeAttr("disabled"), s ? t.attr("onclick", s) :t.removeAttr("onclick");
  }
}
...
function isMessageBoxNeeded(e) {
  var t, o = "mb_sbd", n = 5, i = getCookie(o);
  t = null == i ? [] :i.split(",");
  for (var p = 0; p < t.length; p++) if (e == t[p]) return !1;
  return t.length > n - 1 && (t = t.slice(t.length - n + 1, t.length)), t[t.length] = e,
    i = t.join(","), setCookie(o, i, COOKIE_EXPIRATION_SESSION), !0;
}
...
function createPopup() {
  ...
  o.id = "popupContainer" + e, o.className = "popupContainer", o.style.position = "absolute",
    o.style.zIndex = 2001 + 10 * e, popupContainerInnerHTML = '<div id="popupInner' + e + '" class="popupInner popupShadowBox">	<div class="popupShadowBoxContent">		<div id="popupTitleBar' + e + '" class="popupTitleBar" style="z-index:' + (2003 + 10 * e) + '" onmousedown="startDrag(event, ' + e + ", '" + languageDirection + '\');" onmouseup="stopDrag(event);" onselectstart="return false;">			<div id="popupTitle' + e + '" class="popupTitle" style="float:' + displayLanguageDirection + ';"></div>			<div id="popupControls' + e + '" class="popupControls" style="float:' + displayLanguageOppositeDirection + ';">				<div class="PopupClose" onmouseover="this.className=\'PopupCloseRoll\';" onmouseout="this.className=\'PopupClose\';" onclick="window.closePopup();"></div>			</div>		</div>		<div class="popupTitleShadow" style="z-index:' + (2003 + 10 * e) + '">&nbsp;</div>		<div id="popupPreloaderContianer' + e + '" style="position:relative;z-index:' + (2004 + 10 * e) + ';text-align:left;">			<div id="popupPreloader' + e + '" style="position:absolute;top:0px;left:0px;text-align:left;width:100%;height:100%;background-color:white;z-index:' + (2004 + 10 * e) + '">				<table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%">					<tr>						<td align="center" valign="middle" style="text-align: center; vertical-align: middle;">							<img src="' + AssetManager.R_IMG("/FP/Assets/Images/Misc/Loading-4.gif") + '"></img>						</td>					</tr>				</table>			</div>		</div>		<iframe class="popupFrame" src="about:blank" style="width:100%;height:100%;background-color:transparent;z-index:' + (2002 + 10 * e) + '" scrolling="no" frameborder="0" allowtransparency="true" id="popupFrame' + e + '" name="popupFrame' + e + '" width="100%" height="100%"></iframe>	</div></div>',
...
function showPopWin(e, t, o, n, i, p, a) {
  for (;parent != window && "unknown" != typeof parent.showPopWin && "undefined" != typeof parent.showPopWin; ) return void parent.showPopWin(e, t, o, n, i, p, a);
  if (-2 == gTopmostPopup) return window != window.parent ? void window.parent.showPopWin(e, t, o, n, i, p, a) :void 0;
  if (checkForjQuery(function() {
    showPopWin(e, t, o, n, i, p, a);
    ...
    l && (l.scrolling = i, l.src = "about:blank"), gPopupIsShown = !0, disableTabIndexes(),
    ...
    gPopupParams.url = e, gPopupParams.width = t, gPopupParams.height = o, gPopupParams.returnFunc = n,
      gPopupParams.scrolling = i, gPopupParams.title = p, gPopupParams.isFaceLifted = a,
    ...
    d.style.width = "", gPopupContainer[gTopmostPopup].style.width = t + "px", gPopupContainer[gTopmostPopup].style.height = o + r + "px",
      ...
      showPopWinB(e, t, o, n, i, p, a);
  }
}

function showPopWinB(e, t, o, n, i, p, a) {
  ...
  gReturnFunc[gTopmostPopup] = n, 1 == gHideSelects && hideSelectBoxes(), hideTopmostFlashes();
...
function animatePopup(e, t, o) {
  var n = parseInt(gPopupContainer[gTopmostPopup].style.width), i = parseInt(gPopFrame[gTopmostPopup].style.height);
  return e > n || t > i ? (e - o >= n ? gPopupContainer[gTopmostPopup].style.width = n + o + "px" :gPopupContainer[gTopmostPopup].style.width = e + "px",
    t - o >= i ? gPopFrame[gTopmostPopup].style.height = i + o + "px" :gPopFrame[gTopmostPopup].style.height = t + "px",
    animatePopupTimeoutId = setTimeout("animatePopup(" + e + ", " + t + ", " + o + ")", 10)) :(clearTimeout(animatePopupTimeoutId),
    showPopWinB(gPopupParams.url, gPopupParams.width, gPopupParams.height, gPopupParams.returnFunc, gPopupParams.scrolling, gPopupParams.title, gPopupParams.isFaceLifted)),
    !1;
}
...
function centerPopup(e, t) {
  if (1 == gPopupIsShown) {
    var o = getViewportHeight(), n = getViewportWidth();
    if (isIE && "BackCompat" == document.compatMode) i = document.body.scrollTop, p = document.body.scrollLeft; else var i = jQuery(window).scrollTop(), p = jQuery(window).scrollLeft();
    var a = parseInt(document.getElementById("popupTitleBar" + gTopmostPopup).offsetHeight, 10);
    gPopupContainer[gTopmostPopup].style.top = i + (o - (t + a)) / 2 + "px", gPopupContainer[gTopmostPopup].style.left = p + (n - e) / 2 + "px";
  }
}
...
function hidePopWin(callReturnFunc) {
  if (null != gPopupMask[gTopmostPopup]) {
    ...
    1 == gHideSelects && showSelectBoxes(), showTopmostFlashes(), stopDrag(null), 1 == callReturnFunc && null != gReturnFunc[gTopmostPopup + 1]) {
      var callbackFuncParam = gPopFrame[gTopmostPopup + 1].contentWindow.returnVal;
      if (-1 == gTopmostPopup) {
        var func = gReturnFunc[gTopmostPopup + 1];
        eval(func + "(" + callbackFuncParam + ")");
      } else {
        var frm = gPopFrame[gTopmostPopup].contentWindow;
        if (frm) {
    ...
    var popupFrame = gPopFrame[gTopmostPopup + 1];
    popupFrame && (popupFrame.scrolling = "no", popupFrame.src = "about:blank"), gReturnFunc[gTopmostPopup + 1] = null;
  }
}
...
function disableTabIndexes() {
  if (document.all) for (var e = 0, t = 0; t < gTabbableTags.length; t++) for (var o = document.getElementsByTagName(gTabbableTags[t]), n = 0; n < o.length; n++) gTabIndexes[e] = o[n].tabIndex,
    o[n].tabIndex = -1, e++;
}

function restoreTabIndexes() {
  if (document.all) for (var e = 0, t = 0; t < gTabbableTags.length; t++) for (var o = document.getElementsByTagName(gTabbableTags[t]), n = 0; n < o.length; n++) o[n].tabIndex = gTabIndexes[e],
    o[n].tabEnabled = !0, e++;
}

function changeSelectVisibilty(e, t) {
  if (isIE && ieBrowserVersion <= 6) for (var o = e.document.getElementsByTagName("select"), n = 0; n < o.length; n++) o[n].style.visibility = t;
}
...
function changeFlashVisibilty(e, t) {
  for (var o = e.document.getElementsByTagName("object"), n = 0; n < o.length; n++) o[n].style.visibility = t;
  for (o = e.document.getElementsByTagName("EMBED"), n = 0; n < o.length; n++) o[n].style.visibility = t;
  for (iframesOjects = e.document.getElementsByTagName("iframe"), n = 0; n < iframesOjects.length; n++) 0 != iframesOjects[n].id.indexOf("popupFrame") && (iframesOjects[n].style.visibility = t);
}
...
function startDrag(e, t, o) {
  var n = window.event ? window.event.srcElement :e.target;
  if (!(null != n && n.className.indexOf("PopupClose") >= 0)) {
    1 == gHideSelects && hideSelectBoxes(), hideTopmostFlashes(), mouseDownX = gnn6 ? e.clientX :event.clientX,
      mouseDownY = gnn6 ? e.clientY :event.clientY, gCurrContainer = document.getElementById("popupContainer" + t),
      startX = parseInt(gCurrContainer.style.left), startY = parseInt(gCurrContainer.style.top);
    var i = document.getElementById("dragCover");
    i.style.width = window.document.body.scrollWidth + "px", i.style.height = window.document.body.scrollHeight + "px",
      i.style.cursor = "move", i.style.display = "block", gIsDragging = !0;
  }
}

function moveDrag(e) {
  if (gIsDragging) {
    var t = gnn6 ? startX + e.clientX - mouseDownX :startX + event.clientX - mouseDownX;
    gCurrContainer.style.left = t;
    var o = gnn6 ? startY + e.clientY - mouseDownY :startY + event.clientY - mouseDownY;
    return gCurrContainer.style.top = o, !1;
  }
}

function stopDrag(e) {
  gIsDragging && (document.getElementById("dragCover").style.display = "none", gIsDragging = !1,
    document.getElementById("dragCover").style.cursor = "default"), 1 == gHideSelects && hideSelectBoxes(),
    hideTopmostFlashes();
}

function dontShowAgain(e, t, o, n, i, p) {
  if ("undefined" != typeof e && "undefined" != typeof t && "undefined" != typeof o) {
    "undefined" == typeof n && (n = ""), "undefined" == typeof i && (i = 0), "undefined" == typeof p && (p = !0);
    var a = [ "siteID=" + t, "memberID=" + o, "messageID=" + e, "expiration=" + i ].join("&"), s = "/FP/API/dont-show-again.php", l = getAjaxObject();
    sendAjaxRequest(l, s, a, "", "GET", n, "", "", null, null, p);
  }
}

function dontShowAgainInSession(e, t, o, n, i) {
  if ("undefined" != typeof e && "undefined" != typeof t && "undefined" != typeof o) {
    "undefined" == typeof n && (n = ""), "undefined" == typeof i && (i = !0);
    var p = [ "siteID=" + t, "memberID=" + o, "messageID=" + e ].join("&"), a = "/FP/API/dont-show-again-in-session.php", s = getAjaxObject();
    sendAjaxRequest(s, a, p, "", "GET", n, "", "", null, null, i);
  }
}

function chooseDefaultText(e, t, o) {
  var n = jQuery("#" + e + "_Text");
  if (1 == n.length) {
    var i = jQuery(o).text();
    i.length > 0 && (i = i.substr(0, i.length - 1));
    var n = jQuery("#" + e + "_Text");
    n.val(i + " ").removeClass("DropDownTextArea"), toggleDropdown(e);
    var p = i.length + 1;
    setCursorPosition(n[0], p), n.focus(), null == lastDropDownSelectedId && (lastDropDownSelectedId = new Array()),
      lastDropDownSelectedId[e] = t;
  }
}

function toggleDropdown(e) {
  var t = jQuery("#" + e + "_dropdown"), o = jQuery("#" + e + "_dropdown_inner"), n = jQuery("#" + e + "_Text");
  t.is(":visible") ? t.hide() :(o.css("width", n.outerWidth() + "px"), t.css("display", "inline"));
}
...
function messageBox2(e, t, o, n, i, p, a, s, l) {
  gSection = e, gTitle = t, gBody = o, gIcon = n, gButtons = i, gDefaultButton = p,
...
function cmessageBox2(e, t, o, n, i, p, a, s, l) {
  gSection = e, gTitle = t, gBody = o, gIcon = n, gButtons = i, gDefaultButton = p,
...
function notificationPanelCallback() {
  null != gCallback && eval(gCallback + "(" + gButtons + ")");
}
...
var gi = 0, mhInitialize = window.mhInitialize;

mhInitialize.addEvent(window, "resize", updateMask), window.onscroll = updateMask;

var gIsDragging = !1, gie = document.all, gnn6 = document.getElementById && !document.all, mouseDownX, mouseDownY, gCurrContainer, startX, startY, lastDropDownSelectedId = null, dcb_currentDynamicComboBox = null;
...
DynamicComboBox.prototype.setValues = function(e, t) {
  ...
  if (null != e) {
    ...
    var n = getXmlNodes(e, "element");
    if (null != n && "undefined" != typeof n.length) {
      for (var i = new Array(), p = 0; p < n.length; p++) i[i.length] = getXmlNodeValue(n[p]);
      this.setValues(i), jQuery(this.input).is(":focus") && this.drawValueList(), this.isValueListComplete = o;
    }
  }
  ...
  var o = getRelTop(this.valueList), n = this.valueList.offsetHeight;
  return (this.isValueListOpenedUp || o + n > t) && (e = 0 - n - 20, this.isValueListOpenedUp = !0),
    e;
  ...
  if (this.isInSearchMode) {
    ...
    t = t.replace(/(\W)/gi, "\\$1");
    for (var o = new RegExp('(^|[\\s\\.\\,\\"\\?\\!\\;\\:\\#\\$\\%\\&\\(\\)\\*\\+\\-\\/\\<\\>\\=\\@\\[\\]\\\\\\^\\_\\{\\}\\|\\~]+)(' + t + ")", "ig"), n = new Array(), i = 0; i < e.length; i++) if (o.test(e[i])) {
      var p = htmlStrip(e[i]);
      n[n.length] = p.replace(o, "$1<b>$2</b>"), o.lastIndex = 0;
    }
    e = n;
  }
  ...
  for (var u = document.createElement("TBODY"), i = 0; i < e.length; i++) {
    var r = document.createElement("TR"), d = document.createElement("TD");
    d.className = "DynamicComboBoxValueListCell FL_Label", e[i] == this.selectedValueText && (a = i),
    ...
    }(this, i), d.setAttribute("id", this.id + "_value_" + i), this.isInSearchMode ? d.innerHTML = e[i] :setObjInnerText(d, e[i]),
  ...
  t.attr("width") || t.attr("width", jQuery(this.container).width() - 2), this.valueList.style.display = "block",
    ...
    setTimeout("dcb_turnOnDynamicComboBoxAutoHide('" + this.id + "');", 10);
  ...
  var o = this.id + "_value_" + this.selectedValueIndex, n = this.id + "_value_" + e, i = document.getElementById(o), p = document.getElementById(n);
  t ? p && p.offsetTop + p.offsetHeight + 10 <= this.valueList.offsetHeight + this.valueList.scrollTop && p.offsetTop >= this.valueList.scrollTop && (i && (i.className = "DynamicComboBoxValueListCell FL_Label"),
    p.className = "DynamicComboBoxValueListCellHightlight FL_Label", this.selectedValueText = getObjInnerText(p),
    this.selectedValueIndex = e) :p && (i && (i.className = "DynamicComboBoxValueListCell FL_Label"),
...
function updateBalloonData(o, l, t) {
  var e = jQuery("#balloon_box" + t), n = jQuery("#balloon_box_data" + t);
  n.empty().append(l), null != e.attr("class") && e.attr("class").indexOf("PK_") >= 0 && e.css({
...
function displayBalloon(o, l) {
  function t(o) {
    var l, t, e = balloonWidth, n = balloonHeight, i = 10 + o, a = o / 4 + .5, s = "h" + (e - 40), r = "a" + i + " " + i + " 0 0 1 " + i + " " + i, u = "v" + (n - 48), b = "a" + i + " " + i + " 0 0 1 " + -i + " " + i, p = "h" + -(e - 40), f = "a" + i + " " + i + " 0 0 1 " + -i + " " + -i, h = "v" + -(n - 48), g = "a" + i + " " + i + " 0 0 1 " + i + " " + -i + "z";
    ...
    return "up" == balloonVerticalPosition ? (t = "M20 " + (10 - o), p = "h" + -m + "a20 15 0 0 0 -20 15 a" + a + " " + a + " 0 0 1 " + -(2 * a) + " 0 a20 15 0 0 0 -20 -15h" + -y,
      d = -5) :"down" == balloonVerticalPosition ? (t = "M20 " + (25 - o), s = "h" + y + "a20 15 0 0 0 20 -15 a" + a + " " + a + " 0 0 1 " + 2 * a + " 0 a20 15 0 0 0 20 15h" + m,
      ...
      "right" == balloonHorizontalPosition ? (t = "M20 " + (10 - o), u = "v" + ((n - 48) * l - 20 - a) + "a15 20 0 0 0 15 20 a" + a + " " + a + " 0 0 1 0 " + 2 * a + "a15 20 0 0 0 -15 20v" + ((n - 48) * (1 - l) - 20 - a),
        ...
        c = -15)), t + s + r + u + b + p + f + h + g;
  }
  function e(o) {
    var l = 100 * balloonWidth, t = 100 * balloonHeight, e = 100 * (10 + o), n = 100 * (o / 4 + .5), i = 2e3, a = 1500, s = .5, r = 2e3, u = 2e3, b = u + (l - 4e3), p = r + (t - 4800), f = "", h = "", g = "", y = "";
    if ("up" == balloonVerticalPosition) {
      s = "right" == balloonHorizontalPosition ? .75 :.25;
      var m = b - (l * s - 2 * i - n), B = m - i - n, T = B - i - n, v = p + e + a;
      ...
      r += 1500, p += 1500, s = "right" == balloonHorizontalPosition ? .25 :.75;
      var m = u + (l * s - 2 * i - n), B = m + i + n, T = B + i + n, v = r - e - a;
      f = "at" + (m - i) + "," + (v - a) + "," + (m + i) + "," + (v + a) + "," + m + "," + (v + a) + "," + (m + i) + "," + v + " ",
        f += "wa" + (B - n) + "," + (v - n) + "," + (B + n) + "," + (v + n) + "," + (B - n) + "," + v + "," + (B + n) + "," + v + " ",
        f += "at" + (T - i) + "," + (v - a) + "," + (T + i) + "," + (v + a) + "," + (T - i) + "," + v + "," + T + "," + (v + a) + " ",
        d = 0;
    } else if (s = (parseInt(balloonTailTop, 10) + 25) / (balloonHeight - 48), 0 > (t - 48) * (1 - s) - 25 && (s = .5),
    "right" == balloonHorizontalPosition) {
      var H = r + ((t - 4800) * s - i - n), P = H + i + n, w = P + i + n, O = b + e + a;
      ...
      u += 1500, b += 1500;
      var w = r + ((t - 4800) * s - i - n), P = w + i + n, H = P + i + n, O = u - e - a;
      y = "at" + (O - a) + "," + (H - i) + "," + (O + a) + "," + (H + i) + "," + (O + a) + "," + H + "," + O + "," + (H - i) + " ",
        y += "wa" + (O - n) + "," + (P - n) + "," + (O + n) + "," + (P + n) + "," + O + "," + (P + n) + "," + O + "," + (P - n) + " ",
        y += "at" + (O - a) + "," + (w - i) + "," + (O + a) + "," + (w + i) + "," + O + "," + (w + i) + "," + (O + a) + "," + w + " ",
        c = -15;
    }
    var x = "m" + u + "," + (r - e) + " ", W = "wa" + (b - e) + "," + (r - e) + "," + (b + e) + "," + (r + e) + "," + b + "," + (r - e) + "," + (b + e) + "," + r + " ", _ = "wa" + (b - e) + "," + (p - e) + "," + (b + e) + "," + (p + e) + "," + (b + e) + "," + p + "," + b + "," + (p + e) + " ", L = "wa" + (u - e) + "," + (p - e) + "," + (u + e) + "," + (p + e) + "," + u + "," + (p + e) + "," + (u - e) + "," + p + " ", I = "wa" + (u - e) + "," + (r - e) + "," + (u + e) + "," + (r + e) + "," + (u - e) + "," + r + "," + u + "," + (r - e) + " ", D = x + f + W + h + _ + g + L + y + I;
  ...
  function n(o) {
    ...
    n.appendChild(i);
    var a, s, r = f.length;
    for (a = 0; r > a; a++) s = document.createElementNS("http://www.w3.org/2000/svg", "path"),
      n.appendChild(s), s.setAttribute("fill", f[a].fill), s.setAttribute("stroke", "#000000"),
      s.setAttribute("stroke-opacity", f[a]["stroke-opacity"]), s.setAttribute("d", t(a));
  ...
  var s = document.getElementById("balloon_box" + l), r = document.getElementById(balloonVerticalPosition + "_" + balloonHorizontalPosition + "_balloon_tail" + l);
  if (attachBalloonToBody(s), hideAllSelectComponentsOnIE6(balloonTop, balloonLeft, s.offsetWidth, s.offsetHeight, !0),
    s.style.position = "absolute", s.style.display = "block", s.style.top = balloonTop + "px",
    s.style.left = balloonLeft + "px", s.className.indexOf("PK_") >= 0) {
    ...
    "undefined" != typeof Modernizr && Modernizr.svg ? n(l) :"undefined" != typeof dojox && void 0 != dojox.gfx && void 0 != dojox.gfx.vml ? i(l) :window.isIE ? a(l) :(s.style.border = "5px solid #3295e6",
  ...
  } else r.style.display = "block", "" == balloonVerticalPosition && (r.style.top = balloonTailTop);
...
function requestToShowBalloon(o, l, t, e) {
  openRequestInProgress = !0, callingObjectID = o, updateBalloonVerticalDirection(l, e),
    t ? displayBalloon(0, l) :setTimeout("displayBalloon(0, '" + l + "')", openingBalloonTimeout);
}

function requestToHideBalloon(o) {
  window.clearTimeout(delayedOpenBalloonId), callingObjectID = "", balloonWriteMode || (hideBalloonTimeout = setTimeout("hideBalloon(false, '" + o + "')", closingBalloonTimeout));
}
  ...
  if (l) {
    ...
    if ("down" == balloonVerticalPosition || "up" == balloonVerticalPosition) a = "down" == balloonVerticalPosition ? curMouseY + balloonRefernceObjectHalfHeight :curMouseY - balloonHeight - balloonRefernceObjectHalfHeight,
      ...
      i = "left" == balloonHorizontalPosition ? curMouseX + e + balloonRefernceObjectHalfWidth :curMouseX - balloonWidth - n - balloonRefernceObjectHalfWidth,
        a = Math.max(curMouseY - Math.round(.381966 * s) - 25, document.body.scrollTop),
        balloonTailTop = Math.max(curMouseY - (a + 30) - 15, 10) + "px";
      var r = document.body.scrollTop + document.body.clientHeight;
      a + balloonHeight > r && (a = r - balloonHeight, balloonTailTop = Math.min(curMouseY - (a + 30) - 15, s - 45) + "px");
    }
...
function getBalloonVerticalDirection(o, l) {
  ...
  if (document.all) var a = 0, s = document.body.scrollWidth - document.body.clientWidth - document.body.scrollLeft, r = "LTR" == languageDirection ? document.body.scrollLeft + document.body.clientWidth :document.body.clientWidth + s; else var a = document.body.scrollLeft, r = document.body.scrollLeft + document.body.clientWidth;
...
function setPopupContent(e, o, n) {
  ...
  var l, s;
  if (i.show(), l = t.children().first().width() + newPopupBordersWidth, s = t.children().first().height() + newPopupBordersHeight,
  window.mhNavigation && window.mhNavigation.Accessibility) {
    var r = new window.mhNavigation.Accessibility(), a = r.getZoomLevel();
    l *= a, s *= a, i.css({
      zoom:a
    });
  }
    ...
    if (void 0 != o) {
      if (o.mhFocusOnFirstField) {
        ...
        if (jQuery("#newPopupWindow input[type=" + e + "]:visible:first").focus(), o.preFillFieldValue && "" != o.preFillFieldValue) {
          ...
          jQuery("#newPopupWindow input[type=" + e + "]:visible:first").val(i), jQuery("#newPopupWindow input[type=" + t + "]:visible:first").focus();
        }
      }
  ...
  if (0 != n.length) {
    ...
    if (l > i - s) {
      ...
      if (n.css({
        ...
        var u = jQuery(o), p = u.height() + u.position().top;
        p > a && p - a > n.scrollTop() && window.setTimeout(function() {
          n.scrollTop(p - a);
        }, 0);
      }
    }
...
function popupClosed(e, o) {
  jQuery.isFunction(o.OnBeforeClose) && o.OnBeforeClose.apply(this), e.container.fadeOut("fast", function() {
    e.overlay.fadeOut("fast", function() {
      jQuery.modal.close(), jQuery.isFunction(o.OnAfterClose) && o.OnAfterClose.apply(this);
    });
...
function triggerAnimation() {
  prevnext_animationInterval = window.setInterval("animatePrevNextMechanism()", ANIMATION_SPEED_IN_MILLIS);
}
...
function inviteIndividual(e, t, n, a) {
  ...
  var o = getAjaxObject();
  sendAjaxRequest(o, INCENTIVIZER_API_DATA_PROCESS_LOCATION, "lang=" + currentUserLang + "&incentiveType=" + INCENTIVE_TYPE_EMAIL + "&dataToProcess=" + encodeURIComponent(i), "", "POST", "inviteIndividualCallback", createCacheKey(e, n), "");
}
...
function inviteIndividualCallback(e, t, n) {
  ...
  if (null != c && (c.style.display = "none"), r) {
    ...
    var T = document.getElementById("invitationLayoutTable");
    if (null != T) T.style.display = "block", restoreButtonSprite2("inviteBtn", !0); else {
      var L = document.getElementById("invitationPreloader");
      null != L && (L.style.display = "none");
    }
    var A = document.getElementById("invitationErrorMessage");
    A.style.display = "", A.innerHTML = d == INCENTIVIZER_API_MEMBER_ALREADY_ASSOCIATED ? INVITATION_PANEL_DUPLICATE_TEXT :INVITATION_PANEL_FAILED_TEXT;
  }
}
...
function openCalloutTimelineLink() {
  writeActivityIndicator(ACTIVITY_CALLOUT, SCENARIO_CALLOUT_TIMELINE);
}
...
function pk_openLanguageSelector(e, a, n) {
  openNewPopup("/FP/Library/LanguageSelector/PK_LanguageSelector.php", "s=" + e + "&lang=" + a, n);
}
...
function languageSelectorLanguageSelected(e) {
  ...
  var n = document.location.href, t = "";
  n.indexOf("#") > -1 && (t = n.substr(n.indexOf("#")), n = n.substr(0, n.indexOf("#"))),
    n += n.indexOf("?") > -1 ? "&page-url-for-lang=" + e :"?page-url-for-lang=" + e;
  var o = new XMLHttpRequest();
  o.open("GET", n), o.setRequestHeader("Content-Type", "application/json"), o.onload = function() {
    try {
...
function onLanguageSelected(e) {
  for (var a = "languageSelectorLabel", n = "languageSelectorLink", t = document.querySelectorAll(".language_list ." + a), o = 0; o < t.length; o++) t[o].classList.remove(a),
    t[o].classList.add(n);
  var l = document.getElementById("link_" + e);
  l && (l.classList.remove(n), l.classList.add(a));
}
...
function openSignupPopup(e, o) {
  ...
  var i = _.map(_.keys(o), function(e) {
...
function postEventClicked(e, n) {
  ...
  "undefined" != typeof BALLOON_TYPE_EVENTS && hideBalloon(!0, BALLOON_TYPE_EVENTS)),
    openCenteredPopup2(t, 530, 371, "", "scroll:no;", "postEventCallback", postEventTitle, !0);
}

function postEventCallback() {}
...
function requestToShowMapCalloutDelayed() {
  hideAllBalloons(!0), updateBalloonLocation(delayedMapCalloutE, BALLOON_TYPE_MAP),
    updateBalloonData(balloonVerticalPosition, getDefaultMapCanvas(delayedMapCalloutAddress, delayedMapCalloutGoogleMapPrintLink, delayedMapCalloutGoogleMapDrivingDirectionsLink, delayedMapCalloutFamilyMapLink, delayedMapCalloutIsFamilyMapNew), BALLOON_TYPE_MAP);
  var e = document.getElementById("mapCanvasIframe");
  null != e && (setTimeout("document.getElementById('mapCanvasIframe').src = \"" + delayedMapCalloutGoogleMapLink + '"', 500),
    requestToShowBalloon("", BALLOON_TYPE_MAP));
}
...
function requestToShowEventCallout(e, a, t, l, o) {
  ...
  delayedEventCalloutE.curMouseX = C, delayedEventCalloutE.curMouseY = u, delayedEventCalloutCacheKey = createEventCalloutCacheKey(a, t, o),
    ...
    lastCalloutEventRequestTS = new Date().getTime(), delayedOpenBalloonId = setTimeout("requestToShowEventCalloutDelayed('" + delayedEventCalloutCacheKey + "'," + lastCalloutEventRequestTS + ")", 500);
}
...
function refreshCommentsListPage() {
  var e = getAjaxObject();
  sendAjaxRequest(e, viewCommentsListURL, "", "", "GET", "refreshCommentsListDone", "", "");
}
...
function refreshCommentsListDone(e, t) {
  ...
  null != a && (a.innerHTML = m, a.style.display = "");
  ...
  if ("" != t && t != e.getAttribute("originalValue")) if (showCAPTCHA) {
    ...
    if (n) {
      if ("none" == n.style.display) {
        ...
        var m = getAjaxObject();
        return void sendAjaxRequest(m, "/FP/API/Utilities/replace-captcha.php", "", "", "GET", "setInitialCommentCaptcha", "", "");
      }
    ...
    var m = getAjaxObject();
    sendAjaxRequest(m, captchaValidatorAPI, captchaRequest, "", "POST", "commentCaptchaValidationCallback", "", "");
...
function commentCaptchaValidationCallback(e, t) {
  ...
  numCaptchaFailures >= maxNumCaptchaFailurs) {
    var n = getAjaxObject();
    sendAjaxRequest(n, "/FP/API/Utilities/replace-captcha.php", "", "", "GET", "replaceCommentCaptcha", "", "");
...
Accelimation.prototype.start = function() {
  ...
  this.instances[i] = t, 1 == this.instances.length && (this.timerID = window.setInterval("Accelimation._paintAll()", this.targetRes));
...
function openEnterAddressPopup(e, t, n) {
  hideAllMenus(n), openCenteredPopup2(t, 436, isIE ? 378 :358, "", "scroll:no;", "", e, !0);
}

function membersAddressesChanged(e) {
  if ("undefined" != typeof membersAddressesArr[e]) {
    var t = membersAddressesArr[e].split("||"), n = document.getElementById("homePhone");
    n.value = t[0];
    ...
    i.value = t[4], i.onchange();
    var a = document.getElementById("usStates");
    a.value = t[3], a.value != t[3] && (a.selectedIndex = 0);
    var o = document.getElementById("canadianProvinces");
    o.value = t[3], o.value != t[3] && (o.selectedIndex = 0);
  }
}

function countryChanged(e) {
  var t = document.getElementById("stateOrDistrictLabel"), n = document.getElementById("usStates"), d = document.getElementById("canadianProvinces"), l = document.getElementById("requiredStateOrProvnice");
  "US" == e ? (l.style.display = "", t.innerHTML = stateLabel, t.style.display = "",
    n.style.display = "", d.style.display = "none") :"CA" == e ? (l.style.display = "",
    t.innerHTML = provinceLabel, t.style.display = "", n.style.display = "none", d.style.display = "") :(l.style.display = "none",
    t.style.display = "none", n.style.display = "none", d.style.display = "none");
}
...
function addFamilyEventsCommonCallback(e, t, n, a) {
  t = unescape(t);
  var d = "<error>", l = "</error>", r = t.indexOf(d), i = t.indexOf(l), n = n.replace(/,/g, "_");
  if (0 > r || 0 > i || t.substring(r + d.length, i) != INCENTIVIZER_API_ALL_OK) {
    alert(errorOccurred), restoreButtonSprite2("addEventBtn" + n, !0);
  ...
  if (null != o) {
    o.style.visibility = "hidden", familyMemberShadingEnabled = !1, setTimeout("familyMemberShadingEnabled = true", 500);
    var v = getNextEventToShow(o);
    null != v ? setTimeout("addFamilyEventsRefreshList('" + n + "'," + (a ? "true" :"false") + ")", 300) :addFamilyEventsRefreshList(n, a);
  }
}
...
function addFamilyEventsRefreshList(e, t) {
  ...
  if (null != n) {
    ...
    if (null != a) a.className = "incentivizerRow AddFamilyEventsRowVisible", jQuery(a).find("select").styledSelect(); else if (isMoreFamilyEventsAvailable) {
      var d, l = n.parentNode, r = !1, i = l.rows.length;
      for (d = 0; i > d; d++) if (l.rows[d].className.indexOf("RowVisible") >= 0) {
        r = !0;
        break;
      }
      r || document.location.reload();
    }
    if (t) {
...
function addEventClicked(e, t, n, a, d, l) {
  var r = e.replace(/,/g, "_"), i = getDateEntryValidationObj(r);
  if (i.isDayMissing || i.isMonthMissing || i.isYearMissing) return addEventsShowError(r, EnterACompleteDate),
    void restoreButtonSprite2("addEventBtn" + r, !0);
  if (!i.isDateValid) return addEventsShowError(r, EnterAValidDate), void restoreButtonSprite2("addEventBtn" + r, !0);
  disableButtonSprite2("addEventBtn" + r), jQuery("#preloader" + r).show(), addEventsHideError(r);
  var s = parseInt(i.selectedDay, 10), o = parseInt(i.selectedMonth, 10), v = parseInt(i.selectedYear, 10);
  addEventSuccessMsg = d;
  var c = i.monthSelect.options[i.monthSelect.selectedIndex].text, u = v + (10 > o ? "0" :"") + o + (10 > s ? "0" :"") + s + "0", E = eventDateFormat.replace(/%1/, c).replace(/%2/, s).replace(/%3/, v), f = e.split(",")[0], m = '<incentivizer-data-process siteID="' + currentSiteId + '" accountID="' + currentUserAccountID + '" incentiveType="' + INCENTIVE_TYPE_EVENT + '" processDataActivityID="' + PROCESS_DATA_ACTIVITY_ID_EVENT + '">';
  ...
  var y = getAjaxObject();
  sendAjaxRequest(y, INCENTIVIZER_API_DATA_PROCESS_LOCATION, "incentiveType=" + INCENTIVE_TYPE_EVENT + "&dataToProcess=" + encodeURIComponent(m), "", "POST", "addFamilyEventsAddCallback", e, ""),
...
function reloadEventsList() {
  ...
  if (null != e || null != t) {
    var n = getAjaxObject();
    sendAjaxRequest(n, reloadEventsAjaxScript, "", "eventsMainContent", "GET", "reloadEventsCallback", "", "");
...
function reloadEventsCallback(e) {
  ...
  if (null != t) {
    ...
    if (null != n) {
      ...
      if (null != d) {
        var l, r = d.length;
        for (l = 0; r > l; l++) ("FirstRow" == d[l].className || "MidRow" == d[l].className) && a++;
      }
      var i = t.getElementsByTagName("SPAN");
      if (null != i) {
        var l, r = i.length;
        for (l = 0; r > l; l++) if ("FL_LabelLargeBold" == i[l].className) {
          resultCaption = i[l];
...
function inviteFamilyMemberClose(e, i, t, n) {
  ...
  "undefined" == typeof i ? (i = INCENTIVE_TYPE_EMAIL, t = INCETIVIZER_ITEM_TYPE_INDIVIDUAL,
    a = "inviteFamilyMemberCloseCallback") :a = "addFamilyEventsCloseCallback";
...
function inviteFamilyMemberFamilyMemberHide(e, i) {
  ...
  t.style.opacity = i / 100, i -= 10, 0 > i ? setTimeout('document.getElementById("familyMember' + e + '").style.display = "none"', 300) :setTimeout("inviteFamilyMemberFamilyMemberHide(" + e + ", " + i + ")", 100);
}
...
function inviteFamilyMemberCommonCallback(e, i, t, n) {
  i = unescape(i);
  var a = "<error>", l = "</error>", r = i.indexOf(a), m = i.indexOf(l), t = t.replace(/,/g, "_"), I = INCENTIVIZER_API_UNEXPECTED_ERROR;
  if (r >= 0 && m >= 0 && (I = i.substring(r + a.length, m)), I != INCENTIVIZER_API_ALL_OK && I != INCENTIVIZER_API_INDIVIDUAL_ALREADY_ASSOCIATED) {
    ...
    return I == INCENTIVIZER_API_MEMBER_ALREADY_ASSOCIATED && (E = INVITE_FAMILY_MEMBER_DUPLICATE_EMAIL_TEXT),
      alert(E), restoreButtonSprite2("inviteFamilyMembersBtn" + t, !0), void jQuery("#InviteFamilyLoading" + t).hide();
  }
  var o = document.getElementById("familyMember" + t);
  o.style.visibility = "hidden", familyMemberShadingEnabled = !1, setTimeout("familyMemberShadingEnabled = true", 500);
  var d = shouldWaitBeforeDisplayingNextFamilyMember(t);
  familyMemberIds[t] = !1, d ? setTimeout("inviteFamilyMemberRefreshList(" + t + "," + (n ? "true" :"false") + ")", 300) :inviteFamilyMemberRefreshList(t, n),
  "undefined" == typeof familyMemberList[hiddenFamilyMemberIndex] && isMoreFamilyMembersAvailable && document.location.reload();
}
...
function inviteFamilyMembersSendEmails(e) {
  disableButtonSprite2("inviteFamilyMembersBtn" + e);
  ...
  var a = getAjaxObject();
  sendAjaxRequest(a, INCENTIVIZER_API_DATA_PROCESS_LOCATION, "lang=" + currentUserLang + "&incentiveType=" + INCENTIVE_TYPE_EMAIL + "&dataToProcess=" + encodeURIComponent(n), "", "POST", "inviteFamilyMembersSendEmailsCallback", e, "");
}
...
function inviteFamilyForGreetingCheck() {
  ...
  if ("" != i && i != e.getAttribute("originalValue")) {
    ...
    if (a > 0 && t) {
      ...
      var E = getAjaxObject();
      return sendAjaxRequest(E, INCENTIVIZER_API_DATA_PROCESS_LOCATION, "lang=" + currentUserLang + "&incentiveType=" + INCENTIVE_TYPE_EMAIL + "&dataToProcess=" + encodeURIComponent(n), "", "POST", "inviteFamilyForGreetingCallback", a, ""),
...
function showZoom(e, t, o, n) {
  ...
  var l = document.getElementById("iframe");
  l.style.display = "none";
  var i = getRelTop(t + "Img"), d = getRelLeft(t + "Img"), m = document.body.clientWidth, r = document.body.clientHeight, c = m + document.body.scrollLeft - d, s = r + document.body.scrollTop - i;
  if (400 > c && d - document.body.scrollLeft > 200) var f = d - 200; else var f = d;
  if (300 > s && i - document.body.scrollTop > 200) {
    if (1 == o) var a = i - 10; else if (2 == o) var a = i - 70; else if (3 == o) var a = i - 100;
  } else var a = i;
  "RTL" == n ? l.style.right = m - d :l.style.left = f, l.style.top = a, document.getElementById("zoomiframe").src = e;
}
...
function hide_all(e) {
  menuTimer = setTimeout("hideTip('" + e + "')", 400);
}
...
function hideMainContextMenu(e) {
  menuTimer = setTimeout("setVisibleElement('" + e + "')", 700);
}
...
!function(e, t) {
  ...
  var i = "https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyDK9s1ZbXwcW6eYr70Xcp0BIkINU3lSxAU", r = 2, s = 300, n = {
...
!function(e) {
  ...
  e.UserStripSitesMatches = function() {
    function e(e, t, i) {
      "undefined" == typeof t && (t = n), "undefined" == typeof i && (i = a), jQuery.ajax({
        url:e,
        data:{
          s:t,
          lang:i,
    ...
    function t(t, i) {
      e([ "", "FP", "API", "DnaMatches", "get-is-eligible-for-dna-matches.php" ].join("/"), t, i);
    }
    function i(t, i) {
      e([ "", "FP", "API", "DnaApp", "get-is-eligible-for-dna-landing-page.php" ].join("/"), t, i);
    }
    var n = null, a = null;
    this.init = function(e, s, c) {
      ...
      o && o.length > 0 && (o = o[0], o.classList.contains("user_strip_matches_dna_has_kits") ? o.addEventListener("click", function() {
        t(currentSiteId, languageCode);
      }) :o.addEventListener("click", function() {
        i(currentSiteId, languageCode);
      }));
    };
  };
}(window.mhNavigation = window.mhNavigation || {});
  ...
  e.Tabs = function() {
    function e() {
      r.find("#tab_sub_menu_item_99990").on("click", function(e) {
        e.preventDefault(), jQuery(this).addClass("active"), writeActivityIndicator(e.currentTarget.dataset.activity, "", !0);
      });
    }
    function n() {
    ...
    function a(e, n) {
      if (l) {
        if (e.hasClass("open") || 0 == e.find(".sub_menu").length) {
          var t = e.find(".tab"), o = t.attr("data-onclick");
          return void (o && (t.removeAttr("data-onclick"), t.attr("onclick", o), t.trigger("click")));
        }
        r.addClass("tap"), r.find(".tab_container").removeClass("open"), e.addClass("open"),
          n.stopPropagation(), n.preventDefault();
      } else e.hasClass("open") ? (r.removeClass("tap"), e.removeClass("open")) :(r.addClass("tap"),
        r.find(".tab_container").removeClass("open"), e.addClass("open"), e.offset().top < 0 && e[0].scrollIntoView()),
        n.stopPropagation(), n.preventDefault();
      u || jQuery(window).on(isIos ? "touchend" :"click", i);
    }
    function s(e, n) {
      function t(e) {
        var t = e.parent();
    ...
    this.init = function(n) {
      r = n, u = r.is(".mh_mobile.mh_responsive *"), l = r.is(".mh_mobile:not(.mh_responsive) *"),
        n.is(".mh_desktop *") ? (n.mouseenter(t).mouseleave(o).focusin(t), n.find(".tab_container").mouseenter(function() {
          ...
          var e = jQuery(this), n = e.attr("onclick");
          n && (e.removeAttr("onclick"), e.attr("data-onclick", n)), e.click(function(e) {
...
!function(i) {
  ...
  i.MobileSubscribe = function() {
    ...
    this.isEnabled = function() {
      ...
      i = n, t = e, i.addClass("visible-xs"), i.html(t);
    }, this.setButton = function(i) {
      t.addClass(i);
    }, this.updateUpgradePlanABTestVariant = function() {
      t.attr("onclick", function(i, t) {
        return t ? t.replace(/&reason=\d+/, "&reason=139") :t;
      });
    };
  };
}(window.mhNavigation = window.mhNavigation || {});
...
!function(i) {
  i.Accessibility = function() {
    function i(i) {
      try {
        var e = t();
        e.menuVisibility = i ? 1 :0, window.localStorage[o] = JSON.stringify(e);
      } catch (s) {}
    }
    function e() {
      var i;
      try {
        var e = t();
        i = "undefined" != typeof e.menuVisibility ? e.menuVisibility :1;
      } catch (s) {
        i = 1;
      }
      return i;
    ...
    function s(i) {
      try {
        var e = t();
        e.zoomLevel = i, window.localStorage[o] = JSON.stringify(e);
      } catch (s) {}
    }
    function t() {
      var i = window.localStorage[o] || "{}";
      return i = JSON.parse(i);
    }
    function c(i) {
      jQuery("#main_content_container").css({
        zoom:i
      }), n(i), jQuery("#masterPageHeader").css({
        zoom:1 + .2 * (i - 1)
      }), jQuery(".font_size_slider").val(i);
    }
    function n(i) {
      var e = location.protocol + "//" + location.host;
      jQuery("iframe").each(function() {
        var s = jQuery(this), t = s.attr("src");
        0 == t.indexOf(e) && s.contents().find("body").css({
          zoom:i
        });
      });
    }
    function a() {
      jQuery(".accessibility_menu_container, .accessibility_toaster").removeClass("accessibility_menu_hidden");
    }
    var o = "accessibility_" + currentUserAccountID;
    this.getZoomLevel = function() {
      ...
      return 1 * i;
    }, this.applyAccessibilitySettings = function() {
      c(this.getZoomLevel()), e() && a();
    }, this.restoreAccessibilityFeatures = function() {
      i(!0), a(), jQuery(".accessibility_menu").removeClass("accessibility_menu_hidden"),
        jQuery.post("/FP/API/Accessibility/enable-accessibility-features.php", "", "", "json");
    }, this.init = function() {
      if (features.exposureService.isFeatureEnabled("Accessibility.Exposure") && 0 != Modernizr.testProp("zoom")) {
        var e = jQuery(".accessibility_menu_container").hasClass("user_disabled");
        i(!e), this.applyAccessibilitySettings(), jQuery("#accessibility_menu_item, .accessibility_menu_arrow").click(function() {
          jQuery(".accessibility_menu").toggleClass("accessibility_menu_hidden");
        }), jQuery("#close_accessibility_menu").click(function() {
          var e = jQuery(".accessibility_menu");
          e.is(":visible") ? e.addClass("accessibility_menu_hidden") :(jQuery(".accessibility_toaster, .accessibility_menu").addClass("accessibility_menu_hidden"),
            i(!1), jQuery.post("/FP/API/Accessibility/disable-accessibility-features.php", "", function(i) {
            1 == i.result && i.message && new MH_Confirm({
              message:i.message
            });
          }, "json"));
        }), jQuery(".font_size_slider").on("input", function() {
...
"undefined" != typeof jQuery && !function() {
  ...
  if (currentUserAccountID && currentSiteId) {
    ...
    var _ = new e.PageHeaderPopupInfo(window);
    _.init("#masterPageHeader .page_header .title_info_button"), i.masterPage = new e.MasterPage(),
      i.masterPage.init({
        wrapper:"#pk_master_wrapper"
      }), i.mobileHeader = new e.MobileHeader();
    var d = new e.Accessibility(), l = new e.MobileMenu(), g = new e.MobileLanguageSelector(), p = new e.MobileNotifications(), m = new e.PageHeaderPopupInfo(window);
    m.init("#masterPageHeader .mobile_header .title_info_button"), jQuery(function() {
      function e(e, i) {
        var n = e.dataset.href, t = e.getAttribute("href");
        return i ? i.search("MoreButton") > -1 ? !1 :n ? (writeActivityIndicator(i, "", !0),
          window.open(n), !1) :t && "#" !== t[0] ? writeRedirectActivity(i, "", t) :(writeActivityIndicator(i, "", !0),
          !1) :void 0;
      }
      var _ = jQuery(".navigation_header .notification_tooltip");
      _.length > 0 && (n.init(currentUserAccountID, _, {
        classname:"balloonStyle notification_tooltip"
      }), o.setNotificationTooltip(n));
      var m = jQuery(".navigation_header .notification_panel");
      if (m.length > 0) {
        t.init(currentUserAccountID, m, m.find(".tooltip_hit_area")), o.setNotificationPanel(t, {
          position:"bottom",
          offsetY:7
        }, jQuery(document.body), "notification_panel_on");
        var v = jQuery(".notification_panel .account_menu_links");
        v.length > 0 && u.notificationMenu.init(jQuery(".notification_panel .account_menu"), v);
      }
      var w = jQuery(".navigation_header .user_strip_notification");
      w.length > 0 && (a.init(w, w.find(".tooltip_hit_area"), w.find(".notification"), w.find(".actions")),
      ...
      var f = jQuery(".navigation_header");
      f.length > 0 && (c.init(f.find("ul.tabs")), i.dockedNavigation.init(f, f.find(".navigation_container"), f.hasClass("dockable"))),
        ...
        d.init();
      var b = jQuery(".navigation_container .mobile_header_menu_links");
      l.init(b, b.find(".back_button a"), b.find(".title"), b.find(".link_list"));
      var y = jQuery(".navigation_container .mobile_header_sites_menu");
      y.length > 0 && l.addMenuItem(y.find(".sites_menu"), u.sitesDropDown);
      var h = jQuery(".navigation_container .mobile_header_account_menu");
      h.length > 0 && l.addMenuItem(h.find(".account_menu"), u.accountMenu);
      var j = jQuery(".navigation_container .mobile_header_help_menu");
      j.length > 0 && l.addMenuItem(j.find(".help_menu"), u.helpMenu), g.init(jQuery("#user_strip_language_picker"), languageCode || "EN"),
        l.addMenuItem(jQuery(".navigation_container .mobile_header_language_menu .language_menu"), g);
      var Q = jQuery(".navigation_container .mobile_header_notifications");
      p.init(Q.find(".message"), Q.find(".actions")), p.setNotification(a);
      var k = jQuery("#go_premium").not(".footer_upgrade_button");
      k && r.init(jQuery(".mobile_subscribe"), k.clone().attr("id", "go_premium_mobile")),
        r.setButton("css_button_big"), r.updateUpgradePlanABTestVariant(), jQuery("body").on("click", ".help-links > a.link", function(i) {
        var n = i.currentTarget, t = n.dataset.activity, a = t ? "UserStrip." + t + ".Click" :void 0;
        return e(n, a);
      }), f.on("click", "ul.tabs > li a[role=menuitem]", function(i) {
        ...
        return window.writeActivityIndicator(e, void 0, void 0, void 0, "NewFooterStatisticsService"),
          window.navigateToBuyDnaKitPageIfEligible(currentSiteId), !1;
      });
    });
  }
}();
function navigateToPageIfEligible(e, i, a, n, g) {
  "undefined" == typeof i && (i = currentSiteId), "undefined" == typeof a && (a = languageCode);
  var l = {
    s:i,
    lang:a
  };
  n && (l.context = n), g && (l.scenario = g), jQuery.ajax({
    url:e,
    data:l,
    dataType:"json",
    type:"GET",
...
function navigateToDnaTestPageIfEligible(e, i) {
  navigateToPageIfEligible([ "", "FP", "API", "FamilyTreeDNA", "get-is-eligible-for-dna-tests.php" ].join("/"), e, i);
}

function navigateToDnaMatchesPageIfEligible(e, i) {
  navigateToPageIfEligible([ "", "FP", "API", "DnaMatches", "get-is-eligible-for-dna-matches.php" ].join("/"), e, i);
}

function navigateToDnaAppPageIfEligible(e, i) {
  navigateToPageIfEligible([ "", "FP", "API", "DnaApp", "get-is-eligible-for-dna-app.php" ].join("/"), e, i);
}

function navigateToChromosomeBrowserPageIfEligible(e, i) {
  navigateToPageIfEligible([ "", "FP", "API", "DnaApp", "get-is-eligible-for-chromosome-browser.php" ].join("/"), e, i);
}

function navigateToDnaLandingPageIfEligible(e, i) {
  navigateToPageIfEligible([ "", "FP", "API", "DnaApp", "get-is-eligible-for-dna-landing-page.php" ].join("/"), e, i);
}

function navigateToDnaEthnicityLandingPageIfEligible(e, i) {
  navigateToPageIfEligible([ "", "FP", "API", "DnaApp", "get-is-eligible-for-dna-ethnicity-landing-page.php" ].join("/"), e, i);
}

function navigateToDnaHowItWorksLandingPageIfEligible(e, i) {
  navigateToPageIfEligible([ "", "FP", "API", "DnaApp", "get-is-eligible-for-dna-how-it-works-landing-page.php" ].join("/"), e, i);
}

function navigateToDnaMatchesLandingPageIfEligible(e, i) {
  navigateToPageIfEligible([ "", "FP", "API", "DnaApp", "get-is-eligible-for-dna-matches-landing-page.php" ].join("/"), e, i);
}

function navigateToDnaFounderPopulationsLandingPageIfEligible(e, i) {
  navigateToPageIfEligible([ "", "FP", "API", "DnaApp", "get-is-eligible-for-dna-founder-populations-landing-page.php" ].join("/"), e, i);
}

function navigateToDnaEthnicityPageIfEligible(e, i) {
  navigateToPageIfEligible([ "", "FP", "API", "DnaApp", "get-is-eligible-for-dna-ethnicity.php" ].join("/"), e, i);
}

function navigateToBuyDnaKitPageIfEligible(e, i, a, n) {
  navigateToPageIfEligible([ "", "FP", "API", "DnaApp", "get-is-eligible-to-buy-dna-kit.php" ].join("/"), e, i, a, n);
}

function navigateToManageDnaPageIfEligible(e, i) {
  navigateToPageIfEligible([ "", "FP", "API", "DnaApp", "get-is-eligible-to-manage-dna.php" ].join("/"), e, i);
}

function navigateToUploadDnaPageIfEligible(e, i) {
  navigateToPageIfEligible([ "", "FP", "API", "DnaApp", "get-is-eligible-to-upload-dna.php" ].join("/"), e, i);
}
...
window.navigateToDnaTestPageIfEligibleTestHelper = navigateToDnaTestPageIfEligible,
  window.navigateToInviteMembersPageIfEligibleTestHelper = navigateToInviteMembersPageIfEligible,
  window.navigateToBuyDnaKitPageIfEligibleTestHelper = navigateToBuyDnaKitPageIfEligible,
...
!function() {
  !function t(e, n, i) {
    ...
    for (var r = "function" == typeof require && require, u = 0; u < i.length; u++) o(i[u]);
    return o;
  }({
    1:[ function(t, e, n) {
      "use strict";
      ...
      }(), r = 9, u = 13, s = 32, a = "Accessibility.SkipNavigationUsages";
      n.NavigationSkipper = function() {
        function t(e, n) {
          i(this, t), this.$body = e, this.usageLogger = n;
        }
        return o(t, [ {
          ...
          value:function() {
            var t = this, e = function() {
              t.$skip.blur();
              var e = jQuery(t.mainContentSelector + " :tabbable" + (t.selectorsToNotFocus || "")).first();
              1 === e.length && (e[0].focus(), t.$body.trigger(jQuery.Event("keyup", {
                which:r
              }))), t.usageLogger(a);
            };
            this.$skip.keyup(function(t) {
              (t.which === u || t.which === s) && e();
            }).mouseup(e);
          }
        }, {
          key:"createSkipElement",
          value:function(t) {
            this.$skip = jQuery("<" + t + "></" + t + ">");
          }
        }, {
          ...
          value:function(t) {
            this.mainContentSelector = t;
          }
        }, {
          key:"setSelectorsToNotFocus",
          value:function(t) {
            t.length > 0 && (this.selectorsToNotFocus = ":not(" + t.join("):not(") + ")");
          }
        }, {
          key:"isEnabled",
          value:function() {
    ...
    2:[ function(t, e, n) {
      "use strict";
      var i = t("./navigationSkipper.es6");
      "undefined" != typeof jQuery && jQuery(function() {
        var t = new i.NavigationSkipper(jQuery("body"), _.partial(writeActivityIndicator, _, void 0, !0));
        t.setMainContentSelector("#main_content_container"), t.isEnabled() && (t.createSkipElement("button"),
          t.setSkipText("Skip navigation"), t.setSelectorsToNotFocus([ "mh-input-container", "g" ]),
          t.setSkipAttribute("class", "css_button css_button_big css_button_inverse"), t.setSkipAttribute("id", "skip_to_main"),
          t.setSkipAttribute("tabindex", 1), t.attachEventsToElement(), t.insertSkipElementToBody());
      });
    }, {
      "./navigationSkipper.es6":1
    } ]
  }, {}, [ 2 ]);
}();
!function() {
...
var MediaUploader = function(e, a, i, d, o, n) {
  ...
  function x(e, a, i, d, o, n, l) {
    ...
    jQuery("#uploadMessage .caption").html(r), isMediaUploaderRedesignEnabled && a === _e && (a = n.dict_media_uploader_all_media_items),
      ...
      return me ? (j(), S(), F(d, !1), setTimeout("document.location.reload();", 1)) :I(d, o.onAfterUpload, l),
        !1;
